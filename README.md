# HelixJump
* Juego clon de Helix Jump
![Gameplay](Gameplay.gif)
* Debido a un crasheo de Unity, perdi gran parte del proyecto y se corrompio cierta parte. Por ende, el juego no funciona del todo correctamente
